...
const QRCodeAccessSchema = new mongoose_1.Schema({
...
const QRCodeAccess = mongoose_1.default.models.QRCodeAccess ||
    mongoose_1.default.model('QRCodeAccess', QRCodeAccessSchema);
exports.default = QRCodeAccess;
